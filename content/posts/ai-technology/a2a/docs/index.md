...
draft: false
author: "A2A项目团队"
description: "Agent2Agent（A2A）协议是一个开放标准，用于实现 AI 代理之间的通信和协作"
keywords: ["A2A", "AI代理", "通信协议", "协作", "JSON-RPC", "互操作性"]
tags: 
  - "文档"
  - "AI"
  - "协议"
...
license: "CC BY-NC-ND"
featured_image: ""
summary: "Agent2Agent（A2A）协议是一个开放标准，用于实现 AI 代理之间的通信和协作，支持复杂工作流和安全通信"
---
